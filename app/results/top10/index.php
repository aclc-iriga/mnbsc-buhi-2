<?php
    ...
    const CRITERIA = [
        ...
        'criteria' => [
            [ 'id' => 11 ], // (Preliminary Q&A) Beauty of Face & Figure, Poise and Carriage
            [ 'id' => 12 ]  // (Preliminary Q&A) Intelligence and Wit
        ]
    ];
        ...
        <div class="container-fluid mt-5" style="page-break-before: always;">
            <div class="row justify-content-center">
                <div class="col-md-12" align="center">
                    <img src="/missbato/competition.png" style="width: 256px;" alt="Event">
                </div>
