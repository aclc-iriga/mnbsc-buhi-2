...
$routes = [
    [ "name" => "Tabulation"                        , "route" => "/mnbsc-buhi-2"                 ],
    ...
    <div class="container d-flex align-items-center justify-content-center" style="min-height: 100vh;" >
        <div>
            <div class="text-center mb-5" >
                ...
                <h1 class="fw-bold" >mnbsc-buhi-2</h1>
                <p class="fst-italic" >Mutya nin Bagong Santa Clara (Buhi, Camarines Sur) 2024</p>
            </div>
